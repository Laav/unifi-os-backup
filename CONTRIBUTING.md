...
Explain security consequences, compatibility assumptions, and manual tests. Changes to authentication, endpoints, deletion, filesystem paths, curl arguments, systemd hardening, Graph permissions, object-storage signing, notifications, monitoring exposure, or secret handling require explicit security review.
