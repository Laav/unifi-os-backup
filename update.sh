...
for file in bin/unifi-backup bin/unifi-mail-backup bin/unifi-backup-check bin/unifi-backup-upload bin/unifi-backup-notify bin/unifi-backup-status lib/unifi-backup-common.sh config/storage.env.example config/ntfy.env.example systemd/unifi-backup.service systemd/unifi-backup.timer; do
...
for optional_config in storage ntfy; do
