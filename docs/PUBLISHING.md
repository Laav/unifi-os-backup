...
5. Confirm no `.unifi`, `.unifi.age`, `.env`, age identity, private key, certificate bundle containing a private key, cookie, token, internal hostname, tenant identifier, real mailbox, or customer data is tracked.
